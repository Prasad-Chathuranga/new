        ...
        <div class="col-lg-2 order-lg-0 order-2">
          <div class="card">
            ...
            <div class="contact">
              ...
              $setting = "SELECT * FROM `setting` WHERE Aid='$id'";
              $setting_query = mysqli_query($conn, $setting);
              $setting_result = mysqli_fetch_array($setting_query);
        ...
        <div class="col-lg-10 order-lg-0 order-1">
          <div class="col-lg-12 pb-4">
            <form action="availableleads.php">
              <input type="text" class="searchBox form-control" name="search" placeholder="Search available leads" ; value="<?php echo isset($_GET["search"]) ? $_GET["search"] : "" ?>" />
            </form>
          </div>
          <div class="row g-4">
            <?php
            ...
            if (mysqli_num_rows($run) > 0) {
              ...
              while ($row = mysqli_fetch_assoc($run)) {
                ...
                // if ($row["JSts"]==1 AND $row["startDate"] >= $date ) {
                   ...
                   if($setting_result['distance'] >= calculatedistance($roww["lat"],  $roww["lng"], $row["lat"], $row["lng"])){
                  ...
                  <div class="box">
                    <div>
                      ...
                      <div class="text-center">
                        ...
                        <?php } else if ($row['endDate'] < date("Y-m-d")) {
                        ?>
