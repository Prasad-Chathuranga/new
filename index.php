<?php 
        ...
        if (isset($_POST["savejob"])) {
                ...
                //   $sql2 = ("INSERT INTO `job`(`business_form`,`type of work`,`company`,`JdesBef`,`gender`,`firstname`,`lastname`,`street`,`postal`,`Jcity`,`phone`,`email`) VALUES ('$flexRadioDefault','$chk','$cname','$descb','$gender','$firstname','$lastname','$street','$postal','$city','$phone','$email')");
                $sql2 = ("INSERT INTO `job`(`business_form`,`type of work`,`company`,`JdesBef`,`Jcity`,`gender`,`firstname`,`lastname`,`street`,`postal`,`city`,`phone`,`email`) VALUES ('$flexRadioDefault','$chk','$cname','$descb','$city','$gender','$firstname','$lastname','$street','$postal','','$phone','$email')");
            ...
            <div class="col-lg-9">
              ...
              <form action="" method="post">
                ...
                <div class="row">
                  ...
                  <div class="col-md-5">
                    <input type="text" name="firstname" class="form-control inputBox onlyalpha" />
                    <p class="smallText">Voornaam</p>
                  </div>
                  <div class="col-md-5">
                    <input type="text" name="lastname" class="form-control inputBox onlyalpha" />
                  ...
                  <div class="col-md-6">
                    <input
                      ...
                      class="form-control inputBox onlyalpha"
                  ...
                  <div class="col-md-2 py-md-0 py-2">
                    <input
                      ...
                      class="form-control inputBox postal"
                      placeholder="1234 AB"
                    />
                  </div>
                  <div class="col-md-4">
                    <!-- <select name="city" id="city" class="form-control inputBox">
                      ...
                      <?php
                      $city = mysqli_query($conn,"SELECT * FROM city order by name");
...
$('.postal').blur(function(){
    var regex = new RegExp("^[0-9]{4}[ ]{1}[a-zA-Z]{2}$");
    ...
    {
        alert('Postal code should be in 1234 AB format');
    }
});
</script>
  </body>
