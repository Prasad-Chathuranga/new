                                ...
                                ?>
                                                <form action="" method="post" enctype="multipart/form-data">
                                                        <div class="row mb-5">
                                                                <div class="col-md-4">
                                                                        <div class="form-check formCheck mb">
                                                                                <input class="formCheckInput form-check-input" type="radio" 
                                                                                name="flexRadioDefault"  
                                                                                value="Particulier" id="flexRadioDefault1" <?php
                                                                        ...
                                                                        <div class="form-check formCheck">
                                                                                <input class="formCheckInput form-check-input" type="radio" name="flexRadioDefault" value="ZZP/Eenmanszaak" id="flexRadioDefault2" <?php
                                                                                                                                                                                                                        if (isset($row['business_form']) && $row['business_form'] == "ZZP/Eenmanszaak") {
                                                                                                                                                                                                                                echo "checked";
                                                                                                                                                                                                                        }
                                                                                                                                                                                                                        ?> />
                                                                                <label class="form-check-label formCheckLabel" for="flexRadioDefault2">
                                                                                        ZZP/Eenmanszaak
                                                                                </label>
                                                                        </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                        <div class="form-check formCheck mb">
                                                                                <input class="formCheckInput form-check-input" type="radio" name="flexRadioDefault" value="V.O.F" id="flexRadioDefault3" <?php
                                                                                                                                                                                                                if (isset($row['business_form']) && $row['business_form'] == "V.O.F") {
                                                                                                                                                                                                                        echo "checked";
                                                                                                                                                                                                                }
                                                                                                                                                                                                                ?> />
                                                                                <label class="form-check-label formCheckLabel" for="flexRadioDefault3">
                                                                                        V.O.F.
                                                                                </label>
                                                                        </div>
                                                                        <div class="form-check formCheck">
                                                                                <input class="formCheckInput form-check-input" type="radio" name="flexRadioDefault" value="B.V" id="flexRadioDefault4" <?php
                                                                                                                                                                                                        if (isset($row['business_form']) && $row['business_form'] == "B.V") {
                                                                                                                                                                                                                echo "checked";
                                                                                                                                                                                                        }
                                                                                                                                                                                                        ?> />
                                                                                <label class="form-check-label formCheckLabel" for="flexRadioDefault4">
                                                                                        B.V.
                                                                                </label>
                                                                        </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                        <div class="form-check formCheck mb">
                                                                                <input class="formCheckInput form-check-input" type="radio" name="flexRadioDefault" value="Stichting/Vereniging" id="flexRadioDefault5" <?php
                                                                                                                                                                                                                        if (isset($row['business_form']) && $row['business_form'] == "Stichting/Vereniging") {
                                                                                                                                                                                                                                echo "checked";
                                                                                                                                                                                                                        }
                                                                                                                                                                                                                        ?> />
                                                                                <label class="form-check-label formCheckLabel" for="flexRadioDefault5">
                                                                                        Stichting/Vereniging
                                                                                </label>
                                                                        </div>
                                                                        <div class="form-check formCheck">
                                                                                <input class="formCheckInput form-check-input" type="radio" name="flexRadioDefault" value="Maatschap" id="flexRadioDefault6" <?php
                                                                                                                                                                                                                if (isset($row['business_form']) && $row['business_form'] == "Maatschap") {
                                                                                                                                                                                                                        echo "checked";
                                                                                                                                                                                                                }
                                                                                                                                                                                                                ?> />
                                                                                <label class="form-check-label formCheckLabel" for="flexRadioDefault6">
                                                                                        Maatschap
                                                                                </label>
                                                                        </div>
                                                                </div>
                                                        ...
                                                        <div class="row mb-5">
                                                                ...
                                                                <div class="col-md-4">
                                                                        <div class="form-check formCheck mb">
                                                                                <input class="checkboxInput form-check-input" type="checkbox" name="typeofbusiness[]" value="Aangifte inkomstenbelasting" id="flexCheckDefault1" <?php
                                                                                                                                                                                                                                        if (in_array("Aangifte inkomstenbelasting", $work)) {
                                                                                                                                                                                                                                                echo "checked";
                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                        ?> />
                                                                                <label class="form-check-label formCheckLabel" for="flexCheckDefault1">
                                                                                        Aangifte inkomstenbelasting
                                                                                </label>
                                                                        </div>
                                                                        <div class="form-check formCheck mb">
                                                                                <input class="checkboxInput form-check-input" type="checkbox" name="typeofbusiness[]" value="Aangifte omzetbelasting btw" id="flexCheckDefault2" <?php
                                                                                                                                                                                                                                        if (in_array("Aangifte omzetbelasting btw", $work)) {
                                                                                                                                                                                                                                                echo "checked";
                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                        ?> />
                                                                                <label class="form-check-label formCheckLabel" for="flexCheckDefault2">
                                                                        ...
                                                                        <div class="form-check formCheck">
                                                                                <input <?php
                                                                                        ...
                                                                                        ?> class="checkboxInput form-check-input" type="checkbox" name="typeofbusiness[]" value="Aangifte" id="flexCheckDefault2" />
                                                                                <label class="form-check-label formCheckLabel" for="flexCheckDefault2">
                                                                                        Aangifte
                                                                                </label>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                        <div class="form-check formCheck mb">
                                                                                <input <?php
                                                                                        ...
                                                                                        ?> class="checkboxInput form-check-input" type="checkbox" name="typeofbusiness[]" value="Volledige boekhouding" id="flexCheckDefault3" />
                                                                                <label class="form-check-label formCheckLabel" for="flexCheckDefault3">
                                                                        ...
                                                                        <div class="form-check formCheck mb">
                                                                                <input <?php
                                                                                        ...
                                                                                        ?> class="checkboxInput form-check-input" type="checkbox" name="typeofbusiness[]" value="Toezicht op de boekhouding" id="flexCheckDefault4" />
                                                                                <label class="form-check-label formCheckLabel" for="flexCheckDefault4">
                                                                        ...
                                                                        <div class="form-check formCheck">
                                                                                <input <?php
                                                                                        ...
                                                                                        ?> class="checkboxInput form-check-input" type="checkbox" name="typeofbusiness[]" value="Jaarrekening" id="flexCheckDefault4" />
                                                                                <label class="form-check-label formCheckLabel" for="flexCheckDefault4">
                                                                                        Jaarrekening
                                                                                </label>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                        <div class="form-check formCheck mb">
                                                                                <input <?php
                                                                                        ...
                                                                                        ?> class="checkboxInput form-check-input" type="checkbox" name="typeofbusiness[]" value="Accountantsverklaring" id="flexCheckDefault5" />
                                                                        ...
                                                                        <div class="form-check formCheck mb">
                                                                                <input <?php
                                                                                        ...
                                                                                        ?> class="checkboxInput form-check-input" type="checkbox" name="typeofbusiness[]" value="Salarisadministratie" id="flexCheckDefault6" />
                                                                                <label class="form-check-label formCheckLabel" for="flexCheckDefault6">
                                                                        ...
                                                                        <div class="form-check formCheck">
                                                                                <input <?php
                                                                                        ...
                                                                                        ?> class="formCheckInput checkboxInput form-check-input" type="checkbox" name="typeofbusiness[]" value="Anders Toelichten bij opdrachtbeschrijving" id="flexCheckDefault6" />
                                                                                <label class="form-check-label formCheckLabel" for="flexCheckDefault6">
                                                        ...
                                                        <div class="d-flex">
                                                                <div class="form-group w-50">
                                                                        ...
                                                                        <select name="salary" class="form-control" required>
                                                                                ...
                                                                                <option value="0" <?php if ("0" == $row['Jsalary']) {
                                                                                                                echo "SELECTED";
                                                                                                        } ?>>Unknown</option>
                                                                                <option value="1" <?php if ("1" == $row['Jsalary']) {
                                                                                                                echo "SELECTED";
                                                                                                        } ?>>€0.00-€50.000</option>
                                                                                <option value="2" <?php if ("2" == $row['Jsalary']) {
                                                                                                                echo "SELECTED";
                                                                                                        } ?>>€50.000-€100.000</option>
                                                                                <option value="3" <?php if ("3" == $row['Jsalary']) {
                                                                                                                echo "SELECTED";
                                                                                                        } ?>>€100.00-€250.000</option>
                                                                                <option value="4" <?php if ("4" == $row['Jsalary']) {
                                                                                                                echo "SELECTED";
                                                                                                        } ?>>€250.00-€500.000</option>
                                                                                <option value="5" <?php if ("5" == $row['Jsalary']) {
                                                                                                                echo "SELECTED";
                                                                                                        } ?>>500.000+</option>
                                                                        </select>
                                                                </div>
                                                                <div class="form-group w-50">
                                                                        ...
                                                                        <!--<input name="city" type="text" class="form-control" value="<?php //echo isset($row["city"]) ? $row["city"] : ""; 
                                                                                                                                        ?>" placeholder="Enter Job City"  required>-->
                                                                </div>
                                                        </div>
                                                        <div class="d-flex">
                                                                <div class="form-group w-50">
                                                        ...
                                                        <div class="col-md-4">
                                                                <div class="form-check formCheck mb">
                                                                        <input class="formCheckInput form-check-input" type="radio" name="gender" value="Male"  <?php
                                                                ...
                                                                <div class="form-check formCheck">
                                                                        <input class="formCheckInput form-check-input" type="radio" name="gender" value="Female" id="flexRadioDefault2" <?php
                                                        ...
                                                        <div class="d-flex">
                                                                ...
                                                                <div class="form-group w-50 kvk-div">
                                                                        <label for="">KVK Number</label>
                                                                        <input name="kvk_number_customer" id="kvk_number_customer" type="text" class="form-control" value="<?php echo isset($row["kvk_number_customer"]) ? $row["kvk_number_customer"] : ""; ?>" placeholder="Enter KVK No" <?php if (isset($row['business_form']) && $row['business_form'] == "Particulier") {
                                                                                                                                                                                                                                                                                                        /**Do nothing*/
                                                                                                                                                                                                                                                                                                } else { ?> required <?php } ?>>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="d-flex">
                                                                ...
                                                                <div class="form-group w-50">
                                                                        ...
                                                                        <select name="status" id="status" class="form-control">
                                                                                <option value="0" <?php if ("0" == $row['JSts']) {
                                                                                                                echo "SELECTED";
                                                                                                        } ?>>Pending</option>
                                                                                <option value="1" <?php if ("1" == $row['JSts']) {
                                                                                                                echo "SELECTED";
                                                                                                        } ?>>Approved</option>
                                                                                <option value="2" <?php if ("2" == $row['JSts']) {
                                                                                                                echo "SELECTED";
                                                                                                        } ?>>Paused</option>
                                                                        </select>
                                                                </div>
